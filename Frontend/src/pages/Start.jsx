...
function Start() {
  ...
  return (
    <div id="start" className='h-screen start w-full bg-[#1a1527] text-white  p-10'>
      ...
      <a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1fQY3xQqn6OmnvKVMGRdhlqXmvOwzVcBk/view?usp=drive_open"><button className='font-bold button border-none w-fit but cursor-none text-[22px] rounded-full px-6 py-2 md:px-8 md:py-3 bg-[#5918DF] text-white'>Resume</button></a>
      </div>
